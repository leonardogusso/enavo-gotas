  ...
  return (
    <section id="course-cta" className="mx-auto max-w-md px-4 text-center">
      ...
      <a 
        ...
        target="_blank" 
        rel="noreferrer"
        className="mt-6 inline-block px-8 py-3 bg-emsblue text-white rounded-lg text-base font-semibold shadow-lg hover:bg-sky-800 transition-transform hover:scale-105"
      >
        Acessar Cursos
      </a>
    </section>
