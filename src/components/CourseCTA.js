...
export function CourseCTA() {
  ...
  return (
    <motion.section id="course-cta" className="mx-auto max-w-md px-4 text-center scroll-mt-20" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={fadeInUp}>
