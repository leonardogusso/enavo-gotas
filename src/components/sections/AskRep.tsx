...
export function AskRep({ doctorName = '', setDoctorName }: AskRepProps) {
  ...
  const handleContactRep = () => {
    brandAnalytics.trackRepContact({
      name: doctorName,
      specialty,
      crm,
      clinic,
        ...
        <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
          ...
          <CardContent className="space-y-6">
            ...
            <Button 
              asChild 
              size="lg" 
              className={`w-full ${question ? 'bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700' : 'bg-gray-400 cursor-not-allowed'} text-white shadow-lg transition-all duration-200`} 
              disabled={!question}
