    ...
    <section id="course-cta" className="py-12 md:py-20 px-4 bg-slate-50">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-2xl overflow-hidden">
            <div className="p-6 md:p-8">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                {/* Conteúdo */}
                <div className="space-y-5">
                  <div className="flex items-center gap-3">
                    <Video className="h-6 w-6 text-purple-600 flex-shrink-0" />
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Baseado em Evidências', 'Educação Continuada', 'Acesso Gratuito'].map((tag, idx) => (
                      <span key={idx} className="inline-flex items-center gap-1.5 bg-white px-3 py-1.5 rounded-full border border-purple-200 text-sm font-medium text-purple-700">
                  ...
                  <Button 
                    asChild 
                    size="lg" 
                    className="w-full md:w-auto bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-md hover:shadow-lg transition-all"
                  >
                    <a 
                      href={courseLink} 
                      target="_blank" 
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-purple-200">Formato:</span>
                          <span className="font-semibold">Vídeo + Material</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-purple-200">Acesso:</span>
                          <span className="font-semibold">Gratuito</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-purple-200">Duração:</span>
