...
import { Calculator as CalculatorIcon, Scale, Baby, Droplets, AlertTriangle, CheckCircle2 } from 'lucide-react';
...
export function Calculator() {
  // ✅ CORRIGIDO: useState agora está DENTRO do componente
                  ...
                  {result.isWarning ? (
                    ...
                    <>
                      ...
                      <div className="bg-slate-50 rounded-lg p-4 space-y-2 text-sm text-slate-700">
                        <p className="font-semibold text-slate-900">Posologia GEA:</p>
